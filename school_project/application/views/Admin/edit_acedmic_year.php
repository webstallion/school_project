                           ...
                           <form name="form" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <?php echo form_input(['class'=>'form-control','name'=>'acdmc_name','placeholder'=>'Enter Acedmic Year','value'=>set_value('acdmc_name',$acedmic_value->name)]); ?>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <?php echo form_input(['class'=>'form-control','name'=>'date_from','placeholder'=>'Enter here','id'=>'datepicker',
                                                'value'=>set_value('date_from',$acedmic_value->date_from)]); ?>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <?php echo form_input(['class'=>'form-control','name'=>'date_to','placeholder'=>'Enter here',
                                                'value'=>set_value('date_to',$acedmic_value->date_to)]); ?>
                                        </div>
                                        <div class="col-sm-4">
