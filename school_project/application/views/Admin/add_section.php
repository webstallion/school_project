    ...
    <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div ="row">
                    <div class="col-md-12">
                        <div class="card">
                            <?php echo form_open('Section/addNewSection',['class'=>'form-horizontal']); ?>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <select name="section_id" class="form-control input-lg">
                                                <option value="">Select ID</option>
                                                 <?php foreach ($classes as $sid){
                                                 ?>
                                                <option value="<?php echo $sid->id; ?>"><?= $sid->class_name; ?></option>
                                                <?php } ?>
