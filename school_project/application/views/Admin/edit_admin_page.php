							...
							<form name="form" method="post">
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<?php echo form_input(['class'=>'form-control','name'=>'user_name','placeholder'=>'Enter user Name',
												'value'=>set_value('user_name',$usertype_list->username)]); ?>
										</div>
										<div class="col-sm-4">
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<?php echo form_input(['class'=>'form-control','name'=>'password','placeholder'=>'Enter Password',
												'value'=>set_value('password',$usertype_list->password)]); ?>
										</div>
										<div class="col-sm-4">
									 ...
									 <div class="form-group row">
										...
										<div class="col-sm-5">
											<select name="user_type" class="form-control input-lg">
												<?php if($usertype_list->type=='admin'){ ?>
												<option value="admin">Admin</option>
												<option value="user">User</option>
												<?php }
													  elseif($usertype_list->type=='user'){?>
														<option value="user">User</option>
														<option value="admin">Admin</option>
												<?php }  
													  else { ?>
									 ...
									 <div class="form-group row">
										...
										<div class="col-sm-5">
											<?php echo form_input(['class'=>'form-control','name'=>'school_code','placeholder'=>'Enter School Code',
												'value'=>set_value('school_code',$usertype_list->scode)]); ?>
										</div>
										<div class="col-sm-4">
									 ...
									 <div class="form-group row">
										...
										<div class="col-sm-5">
											<?php echo form_input(['class'=>'form-control','name'=>'post','placeholder'=>'Enter Post Name',
												'value'=>set_value('post',$usertype_list->post)]); ?>
										</div>
										<div class="col-sm-4">
