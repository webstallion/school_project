	...
	<div class="page-wrapper">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<?php echo form_open('Employee_module/add',['class'=>'form-horizontal']); ?>
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<?php echo form_input(['class'=>'form-control','name'=>'employee','placeholder'=>'Enter Employee Name','value'=>set_value('employee')]); ?>
										</div>
										<div class="col-sm-4">
